...
As they simply transform your input object to a shape that next understands, you may also use them in the standard `getServerSideProps` functions if you want.

## json

Wraps the input object in `{ props: { ... } }`, which are then provided as props to the page component.
...
Redirect translates your destination path and options to the redirect object that Next understands.

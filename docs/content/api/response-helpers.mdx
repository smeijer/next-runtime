...
These response helpers return an
[`Response`](https://developer.mozilla.org/en-US/docs/Web/API/Response/Response)
object. Thereby, they won't function with standard `getServerSideProps`
functions. If you're getting a serialization error like below, then you're
probably using these out of the context of `next-runtime/handle`.

...
Just as with the standard `post` handler, this form can be upgraded to a `Form` as well. Please see [data updates - upgrading to form](/getting-started/4-data-updates#upgrading-to-form) for how to do that.

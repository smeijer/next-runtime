...
I've always been a big fan of simplicity, and reducing boilerplate. The YouTube video [CDN Caching, Static Site Generation, and Server Side Rendering](https://www.youtube.com/watch?v=bfLFHp7Sbkg) by [Ryan Florence](https://twitter.com/ryanflorence?lang=en) just clicked, and has been an huge inspiration for this project. You can clearly see my attempt to bring a bit of the simplicity that Remix offers to Next.js. Some functions have their signature all over it, because my goal is to have a Remix-like API/philosophy in Next for those that are unable to switch. Credit where credit's due. <span class="text-red-600">❤</span>️ [Remix](https://remix.run), go check 'm out!
